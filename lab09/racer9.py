...
# Background
background_img = pygame.image.load("/Users/altynajsajlau/Downloads/AnimatedStreet.png")
screen.fill(WHITE)

# Music
pygame.mixer.music.load("/Users/altynajsajlau/Downloads/lab8_racer_background.wav")
pygame.mixer.music.play(-1)

# Coin
coin_image = pygame.image.load("/Users/altynajsajlau/Downloads/Coin.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/altynajsajlau/Downloads/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/altynajsajlau/Downloads/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        crash_sound = pygame.mixer.Sound("/Users/altynajsajlau/Downloads/lab8_racer_crash.wav")
        crash_sound.play()
